  ...
  return (
    <Router>
      <div>
        ...
        {/* Route to render countries */}
        <Routes>
          <Route path="/" element={<Countries countries={filteredCountries} navigate={navigate} />} />
          <Route path="/countries" element={<Countries countries={filteredCountries} navigate={navigate} />} />
